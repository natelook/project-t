  ...
  return (
    <li className="col-span-1 flex flex-col text-center bg-white rounded-lg shadow divide-y divide-gray-200">
      <div className="flex flex-col pb-4">
        <div className="relative w-full h-32 bg-gray-900 border-b border-gray-200 overflow-hidden rounded-tl rounded-tr flex justify-center items-center">
          <code className="text-gray-400 uppercase">Team Image</code>
        </div>

        <div className="mt-6">
          <h3 className="text-gray-900 text-lg font-bold">{team.name}</h3>
