            ...
            {session ? (
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                <Menu as="div" className="ml-3 relative z-20">
                  ...
                  >
                    <Menu.Items className="origin-top-right absolute right1 mt-2 w-48 rounded-md shadow-lg py-1 dark:bg-gray-800 ring-1 ring-black ring-opacity-5 focus:outline-none">
                      <Menu.Item>
                        {({ active }: any) => (
                          <div>
                            <Link href="/profile">
